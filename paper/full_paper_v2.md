...
> Revised manuscript (v2). The artifact now custodies capital and settles on dissolution
...
*khiyar* and *iqalah* remains open.
...
access-control findings**. A deeper Slither pass is identified as future hardening.
